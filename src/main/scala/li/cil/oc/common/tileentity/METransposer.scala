...
class METransposer extends traits.Environment with traits.TransposerActivity with IGridProxyable with IActionHost with IPowerChannelState {
  protected def blockName = Constants.BlockName.METransposer

  protected def createComponent: component.METransposer = new component.METransposer(this)
